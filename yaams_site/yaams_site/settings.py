# Django settings for yaams_site project.

DEBUG = False
TEMPLATE_DEBUG = False

#Custom Additions For Memcache
MEMCACHE = {
	'hosts': ['127.0.0.1:11211',], #a list of addresses that contain memcache servers you wish to use
...
ROOT_URLCONF = 'yaams_site.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'yaams_site.wsgi.application'
