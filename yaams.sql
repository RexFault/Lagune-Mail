...
INSERT INTO `auth_user` VALUES (1,'Shane','','','shane@packetunderground.com','PASSWORD HASH HERE!!!',1,1,1,'2012-09-23 03:55:35','2012-06-04 01:14:21');
...
INSERT INTO `django_content_type` VALUES (1,'permission','auth','permission'),(2,'group','auth','group'),(3,'user','auth','user'),(4,'content type','contenttypes','contenttype'),(5,'session','sessions','session'),(6,'site','sites','site'),(7,'news post','yaams','newspost'),(8,'log entry','admin','logentry'),(9,'email user','yaams','emailuser');
...
--
-- Table structure for table `yaams_emailuser`
--

DROP TABLE IF EXISTS `yaams_emailuser`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `yaams_emailuser` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `email_address` varchar(257) NOT NULL,
  `password_protected` tinyint(1) NOT NULL,
  `password_hash` varchar(52) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `yaams_emailuser`
--

LOCK TABLES `yaams_emailuser` WRITE;
/*!40000 ALTER TABLE `yaams_emailuser` DISABLE KEYS */;
INSERT INTO `yaams_emailuser` VALUES (6,'shane@gizmo.lagune-software.com',1,'PASSWORD HERE'),(7,'test@gizmo.lagune-software.com',0,''),(8,'test@gizmo.lagune-softawre.com',0,'');
/*!40000 ALTER TABLE `yaams_emailuser` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2012-10-04 10:21:48
